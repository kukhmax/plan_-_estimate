...
- **Status**: Implemented 2026-09-16 (backend; **uncommitted — awaiting owner acceptance**; Git operations performed manually by the owner after acceptance)
- **Date**: 2026-09-16
- **Commit**: none yet — owner performs the commit/push after acceptance
